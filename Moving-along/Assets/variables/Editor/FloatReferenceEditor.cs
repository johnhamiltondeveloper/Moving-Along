...
public class FloatReferenceEditor : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (EditorGUI.DropdownButton(rect, new GUIContent(EditorGUIUtility.whiteTexture), FocusType.Keyboard,new GUIStyle() {fixedWidth = 50f, border = new RectOffset(1,1,1,1)}))
        {
